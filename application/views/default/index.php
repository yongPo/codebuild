...
<section class="youplay-banner banner-top youplay-banner-parallax">
        ...
        <div class="image" data-speed="0.4">
            <img src="<?php echo base_url(); ?>assets/default/images/dark/banner-bg.jpg" alt="" class="jarallax-img">
        </div>
...
<!-- /Banner -->
    ...
    <div class="youplay-carousel" data-autoplay="5000">
        <a class="angled-img" href="store-product-1.html">
            <div class="img">
                <img src="<?php echo base_url(); ?>assets/default/images/dark/game-bloodborne-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div><div>
                        <h4>Bloodborne</h4>
    ...
    <div class="rating">
        ...
        <a class="angled-img" href="#">
            <div class="img">
                <img src="<?php echo base_url(); ?>assets/default/images/dark/game-dark-souls-ii-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div><div>
                        <h4>Dark Souls II</h4>
    ...
    <div class="rating">
        ...
        <a class="angled-img" href="#">
            <div class="img">
                <img src="<?php echo base_url(); ?>assets/default/images/dark/game-lords-of-the-fallen-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div><div>
    ...
    <div class="rating">
        ...
        <a class="angled-img" href="#">
            <div class="img">
                <img src="<?php echo base_url(); ?>assets/default/images/dark/game-middle-eart-shadow-of-mordor-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div><div>
    ...
    <div class="rating">
        ...
        <a class="angled-img" href="#">
            <div class="img">
                <img src="<?php echo base_url(); ?>assets/default/images/dark/game-soul-sacrifice-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div><div>
    ...
    <div class="rating">
        ...
        <a class="angled-img" href="#">
            <div class="img">
                <img src="<?php echo base_url(); ?>assets/default/images/dark/game-kingdoms-of-amalur-reckoning-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div><div>
    ...
    <div class="rating">
        ...
        <a class="angled-img" href="#">
            <div class="img">
                <img src="<?php echo base_url(); ?>assets/default/images/dark/game-the-witcher-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div><div>
    ...
    <div class="rating">
        ...
        <a class="angled-img" href="#">
            <div class="img">
                <img src="<?php echo base_url(); ?>assets/default/images/dark/game-diablo-iii-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div><div>
    ...
    <div class="rating">
        ...
        <a class="angled-img" href="#">
            <div class="img">
                <img src="<?php echo base_url(); ?>assets/default/images/dark/game-dragons-dogma-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div><div>
                        <h4>Dragons Dogma</h4>
    ...
    <div class="rating">
        ...
        <a class="angled-img" href="#">
            <div class="img img-offset">
                <img src="<?php echo base_url(); ?>assets/default/images/dark/game-prototype-500x375.jpg" alt="">
                <div class="badge bg-default">
                    +10%
                </div>
            </div>
    ...
    <div class="rating">
        ...
        <a class="angled-img" href="#">
            <div class="img img-offset">
                <img src="<?php echo base_url(); ?>assets/default/images/dark/game-half-life-3-500x375.jpg" alt="">
                <div class="badge bg-default">
                    So Sad
                </div>
            </div>
    ...
    <section class="youplay-banner youplay-banner-parallax small">
        <div class="image" data-speed="0.4">
            <img class="jarallax-img" src="<?php echo base_url(); ?>assets/default/images/dark/banner-witcher-3.jpg" alt="">
        </div>
    ...
    <section class="youplay-banner youplay-banner-parallax small mt-80">
        <div class="image" data-speed="0.4">
            <img class="jarallax-img" src="<?php echo base_url(); ?>assets/default/images/dark/banner-bg.jpg" alt="">
        </div>
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div class="youplay-carousel youplay-carousel-size-6" data-autoplay="6000" data-arrows="false" data-stage-padding="0">
                            <a href="#"><img src="<?php echo base_url(); ?>assets/default/images/dark/partner-logo-1.png" alt=""></a>
                            <a href="#"><img src="<?php echo base_url(); ?>assets/default/images/dark/partner-logo-2.png" alt=""></a>
                            <a href="#"><img src="<?php echo base_url(); ?>assets/default/images/dark/partner-logo-3.png" alt=""></a>
                            <a href="#"><img src="<?php echo base_url(); ?>assets/default/images/dark/partner-logo-4.png" alt=""></a>
                            <a href="#"><img src="<?php echo base_url(); ?>assets/default/images/dark/partner-logo-5.png" alt=""></a>
                            <a href="#"><img src="<?php echo base_url(); ?>assets/default/images/dark/partner-logo-6.png" alt=""></a>
                            <a href="#"><img src="<?php echo base_url(); ?>assets/default/images/dark/partner-logo-7.png" alt=""></a>
                            <a href="#"><img src="<?php echo base_url(); ?>assets/default/images/dark/partner-logo-8.png" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
